...
<ol><div id="badges">
  <a href="https://aigitalpro.ru">
    <img src="https://img.shields.io/badge/Aigital-green?style=for-the-badge&logo=Aigital&logoColor=white" alt="Aigital Badge"/>
  </a>
</div> </ol>

<p>Что нужно было сделать:<p>
<ol>Задача: Полное тестирование GUI, тестирование работы отправки различных запросов через соответствующие разделы приложения, анализ полученных от искусственного интеллекта (ИИ) результатов, как в desktop-версии, так и в mobile-версии.</ol>
...
<p>- профиль</p>
<p>- проверка UX/UI</p>
<p>- результаты работы AI в каждом шаблоне</p>
<p>- субъективная оценка качества результата, выдаваемого нейросетями</p>
<p>- адаптивная вёрстка</p>
Баг-репорты и рекомендации заводил в ClickUp;</p>
 
 <p>Итоги тестирования продукта:<p>
<ol>По итогам тестирования было выявлено и оформлено в виде баг-репортов 49 дефектов, из которых 2 блокера + описаны 23 рекомендации для улучшения UX/UI.</ol>

 <p>Итоги моей работы над проектом:<p>
<ol>Получил опыт работы full-time в составе команды тестирования, а так же опыт участия в ежедневных созвонах с командой тестирования и Project Manager в Google Meet и еженедельных — с разработчиками. Нашёл и описал в баг-репортах 49 дефектов и 23 рекомендации.</ol>
